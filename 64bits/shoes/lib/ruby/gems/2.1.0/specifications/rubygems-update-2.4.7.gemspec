# -*- encoding: utf-8 -*-
# stub: rubygems-update 2.4.7 ruby hide_lib_for_update
...
Gem::Specification.new do |s|
  ...
  s.files = ["CONTRIBUTING.rdoc", "CVE-2013-4287.txt", "CVE-2013-4363.txt", "History.txt", "LICENSE.txt", "MIT.txt", "Manifest.txt", "README.rdoc", "UPGRADING.rdoc", "bin/update_rubygems", "hide_lib_for_update/note.txt"]
